...
const news: INews[] = [
  {
    ...
    desc: 'Узнайте о последних обновлениях и улучшениях в ваших любимых играх.',
    date: '15 марта 2025',
  ...
  },
  {
    ...
    desc: 'Присоединяйтесь к просмотру и делайте ставки на один икс бет.',
    date: '10 марта 2025',
  ...
  },
  {
    ...
    desc: 'Познакомьтесь с новыми играми, в нашем каталоге.',
    date: '5 марта 2025',
